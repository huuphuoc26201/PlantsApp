...
import com.example.myapplication.myArticles


class mySpeciesAdapter(userList1: myArticles, private val userList: ArrayList<listSpeciesData>) : RecyclerView.Adapter<mySpeciesAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener(View.OnClickListener {
            ...
            intent.putExtra("prev", "myspeciies")
