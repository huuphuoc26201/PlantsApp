...
import com.example.myapplication.plantTypes


class listPlantsAdapter(userList1: plantTypes, private val userList: ArrayList<listSpeciesData>) : RecyclerView.Adapter<listPlantsAdapter.MyViewHolder>() {
