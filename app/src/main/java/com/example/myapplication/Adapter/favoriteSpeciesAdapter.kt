...
import com.example.myapplication.favorite.speciesFragment
import com.example.myapplication.model.listSpeciesData


class favoriteSpeciesAdapter(userList1: speciesFragment.Companion, private val userList: ArrayList<listSpeciesData>) : RecyclerView.Adapter<favoriteSpeciesAdapter.MyViewHolder>() {
