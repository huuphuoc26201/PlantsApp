...
import com.example.myapplication.followChannel
import com.example.myapplication.model.articlesData


class followChannelAdapter(userList1: followChannel, private val userList: ArrayList<articlesData>) : RecyclerView.Adapter<followChannelAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener(View.OnClickListener {
            ...
            intent.putExtra("prev", "followchannel")
