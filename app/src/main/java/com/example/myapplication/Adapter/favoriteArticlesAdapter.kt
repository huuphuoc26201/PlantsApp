...
import com.example.myapplication.favorite.ArticlesFragment
import com.example.myapplication.model.articlesData


class favoriteArticlesAdapter(userList1: ArticlesFragment.Companion, private val userList: ArrayList<articlesData>) : RecyclerView.Adapter<favoriteArticlesAdapter.MyViewHolder>() {
